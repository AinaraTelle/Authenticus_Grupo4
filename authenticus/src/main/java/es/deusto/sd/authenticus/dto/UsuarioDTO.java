...
public class UsuarioDTO{
    ...
    public UsuarioDTO(String nombre, String email, String password, int tel) {
        this.email = email;
    ...
    public UsuarioDTO(int iDUsuario, String nombre, String email, String password, int tel) {
        IDUsuario = iDUsuario;
        this.email = email;
        this.password = password;
        this.nombre = nombre;
